      ...
      class Pdf < Base
        ...
        register_instance_option :controller do
          Proc.new do
            ...
            random_file_name = (0...8).map { (65 + rand(26)).chr }.join
            pdf_file = "public/#{random_file_name}.pdf"
            graph_file = "public/#{random_file_name}_graph.jpg"
            ...
            Prawn::Document.new(PDF_OPTIONS) do |pdf|
              ...
              if @object.comissions.where(status: :pending).count > 0
                ...
                pdf.text "Comissões Pendentes", size: true
                pdf.move_down 20
              end
              ...
              if @object.sales.count > 0
                ...
                pdf.image graph_file, scale: 0.50
              end
              ...
              # Inclui em baixo da folha do lado direito a data e o número da página usando a tag page
            ...
            File.delete(graph_file) if @object.sales.count > 0
          end
        end
